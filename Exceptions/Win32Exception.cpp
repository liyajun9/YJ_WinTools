...
CWin32Exception::CWin32Exception(PCTSTR pszClass/* = _T("unknownClass")*/, PCTSTR pszMethod/* = _T("unknownMethod")*/, PCTSTR pszAPIName/* = _T("unknownAPI")*/)
{
...
_tstring CWin32Exception::GetMsg()
{
	return m_sMsg;
}
...
_tstring CWin32Exception::GetLastErrorMsg(DWORD errcode)
{
	LPVOID lpMsgBuf; 
	if(!FormatMessage( 
